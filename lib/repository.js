  ...
  write: function (options, callback) {
    ...
    try {
      ...
      repo.commit = function (vm, callback) {
        ...
        repo.emit('before-database-commit', vm);
        orgCommit.apply(this, [vm, function (err, res) {
          repo.emit('after-database-commit', vm);
      ...
      repo.find = function (query, queryOptions, callback) {
        ...
        repo.emit('before-database-find', query, queryOptions);
        orgFind.apply(this, [query, queryOptions, function (err, res) {
          repo.emit('after-database-find', query, queryOptions);
          if (err) {
            return callback(err);
          }
      ...
      repo.findOne = function (query, queryOptions, callback) {
        ...
        repo.emit('before-database-findOne', query, queryOptions);
        orgFindOne.apply(this, [query, queryOptions, function (err, res) {
          repo.emit('after-database-findOne', query, queryOptions);
          if (callback) callback(err, res);
        }]);
      };
      ...
      repo.get = function (id, callback) {
        ...
        repo.emit('before-database-get', id);
        orgGet.apply(this, [id, function (err, res) {
          repo.emit('after-database-get', id);
          if (callback) callback(err, res);
        }]);
      };
