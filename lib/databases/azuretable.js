...
var generateObject = function (entity) {
    ...
    obj = _.omit(obj, 'Timestamp', '.metadata');
...
_.extend(AzureTable.prototype, {
    ...
    get: function (id, callback) {
        ...
        var PartitionKey = id.PartitionKey || id;
        var RowKey = id.RowKey || id;

        console.log('AZURETABLE GET');
        console.log(id);
        console.log(id.PartitionKey);
    ...
    commit: function (vm, callback) {
        ...
        self.checkConnection(function (err) {
            ...
            var objDescriptor = {
                PartitionKey: eg.String(vm.PartitionKey || vm.id),
                RowKey: eg.String(vm.RowKey || vm.id)
            };
